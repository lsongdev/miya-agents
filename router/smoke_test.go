...
func TestSmoke_ChatCompletions_OpenAI(t *testing.T) {
	...
	r.OnRequest(func(ctx RequestContext, chatReq *openai.ChatCompletionRequest) (string, error) {
		return "oai", nil
	})
...
func TestSmoke_Errors(t *testing.T) {
	...
	t.Run("rejected by hook", func(t *testing.T) {
		...
		r2.OnRequest(func(ctx RequestContext, chatReq *openai.ChatCompletionRequest) (string, error) {
